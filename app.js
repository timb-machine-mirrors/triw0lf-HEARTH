    ...
    cells: [
      {
        ...
        source: [
          ...
          '## About This Notebook\n',
          '\n',
          'This notebook contains threat hunting scenarios generated using the PEAK framework. Each hunt follows the three-phase PEAK methodology:\n',
          '\n',
      ...
      },
      {
        ...
        source: [
          ...
          '\n',
          '---\n',
          '*Generated using PEAK Threat Hunting Framework from HEARTH*'
        ]
      }
    ],
    metadata: {
...
function showHuntJsonData(huntId) {
  ...
  modalBody.innerHTML = `
    <div class="hunt-json-data">
      ...
      <p>Copy the JSON below and use it with the 
      ...
      <div class="usage-instructions">
        ...
        <ol>
          ...
          <li>Clone the threat-hunting-notebook-generator repository</li>
    ...
    modalBody.innerHTML = `
      <div class="notebook-success">
        ...
        <div class="notebook-github">
          <p><strong>Advanced Option:</strong> For more sophisticated notebook generation, you can use our 
          <a href="https://github.com/THORCollective/threat-hunting-notebook-generator" target="_blank">threat-hunting-notebook-generator</a> 
      ...
      modalBody.innerHTML = `
        <div class="notebook-error">
          ...
          <div class="error-fallback">
            <p><strong>Alternative:</strong> You can manually create a notebook using the hunt details shown above and the 
